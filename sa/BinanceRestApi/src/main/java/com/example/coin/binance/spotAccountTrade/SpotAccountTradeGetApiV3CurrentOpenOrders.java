...
public class SpotAccountTradeGetApiV3CurrentOpenOrders extends SAProxy {
	public DataSet GetApiV3CurrentOpenOrders(DataSet InDs, String InDsNames, String outDsNames) throws Exception {
