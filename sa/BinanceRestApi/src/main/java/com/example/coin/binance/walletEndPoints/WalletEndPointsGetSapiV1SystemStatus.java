...
public class WalletEndPointsGetSapiV1SystemStatus extends SAProxy {
	// https://binance-docs.github.io/apidocs/spot/en/#all-coins-39-information-user_data
	public DataSet GetSapiV1SystemStatus(DataSet InDs, String InDsNames, String outDsNames) throws Exception {
		...
		OUT_REST.addColumn("STATUS", dataset.type.DataType.STRING, null, "status");
		OUT_REST.addColumn("MSG", dataset.type.DataType.STRING, null, "msg");
		...
		try {
			jsonOutString = httpU.httpGetBinianceGetUrlNoAuth(URL, null);
		...
		if (c != null) {
			...
			dr.setString("MSG", c.get("msg").toString());
		}
		return OUT_DS;
	}
