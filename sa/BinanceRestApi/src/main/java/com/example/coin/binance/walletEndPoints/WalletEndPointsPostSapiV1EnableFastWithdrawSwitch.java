...
public class WalletEndPointsPostSapiV1EnableFastWithdrawSwitch extends SAProxy {
	// https://binance-docs.github.io/apidocs/spot/en/#all-coins-39-information-user_data
	public DataSet PostSapiV1EnableFastWithdrawSwitch(DataSet InDs, String InDsNames, String outDsNames)
			throws Exception {
		String URL = "https://api.binance.com/sapi/v1/account/enableFastWithdrawSwitch";
