...
public class MarketDataEndPointsGetApiV3SymbolPriceTicker extends SAProxy {
	// https://binance-docs.github.io/apidocs/spot/en/#all-coins-39-information-user_data
	public DataSet GetApiV3SymbolPriceTicker(DataSet InDs, String InDsNames, String outDsNames) throws Exception {
		...
		OUT_REST.addColumn("PRICE", dataset.type.DataType.STRING, null, "price");
