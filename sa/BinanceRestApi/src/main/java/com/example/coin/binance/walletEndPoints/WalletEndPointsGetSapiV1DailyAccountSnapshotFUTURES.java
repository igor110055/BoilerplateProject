...
public class WalletEndPointsGetSapiV1DailyAccountSnapshotFUTURES extends SAProxy {
	// https://binance-docs.github.io/apidocs/spot/en/#all-coins-39-information-user_data
	public DataSet GetSapiV1DailyAccountSnapshotFUTURES(DataSet InDs, String InDsNames, String outDsNames)
			throws Exception {
		...
		DataTable OUT_RSET_DATA__ASSETS = OUT_DS.addTable("OUT_RSET_DATA__ASSETS");
		OUT_RSET_DATA__ASSETS.addColumn("SEQ");
		OUT_RSET_DATA__ASSETS.addColumn("ASSET");
		OUT_RSET_DATA__ASSETS.addColumn("MARGIN_BALANCE");
		OUT_RSET_DATA__ASSETS.addColumn("WALLET_BALANCE");

		DataTable OUT_RSET_DATA__POSITION = OUT_DS.addTable("OUT_RSET_DATA__POSITION");
		OUT_RSET_DATA__POSITION.addColumn("SEQ");
		OUT_RSET_DATA__POSITION.addColumn("ENTRY_PRICE");
		OUT_RSET_DATA__POSITION.addColumn("MARK_PRICE");
		OUT_RSET_DATA__POSITION.addColumn("POSITION_AMT");
		OUT_RSET_DATA__POSITION.addColumn("SYMBOL");
		OUT_RSET_DATA__POSITION.addColumn("UN_REALIZED_PROFIT");
			...
			if (c.get("snapshotVos") != null) {
				...
				for (int i = 0; i < al.size(); i++) {
					...
					if (tmp.get("data") != null) {
						...
						if (tmp2.get("assets") != null) {
							ArrayList<HashMap<String, Object>> al2 = (ArrayList<HashMap<String, Object>>) tmp2
									.get("assets");
							for (int j = 0; j < al2.size(); j++) {
								HashMap<String, Object> tmp3 = al2.get(j);
								DataRow DR_OUT_RSET_DATA__ASSETS = OUT_RSET_DATA__ASSETS.addRow();
								DR_OUT_RSET_DATA__ASSETS.setString("SEQ", i + "");
								DR_OUT_RSET_DATA__ASSETS.setString("ASSET", tmp3.get("asset").toString());
								DR_OUT_RSET_DATA__ASSETS.setString("MARGIN_BALANCE",
										tmp3.get("marginBalance").toString());
								DR_OUT_RSET_DATA__ASSETS.setString("WALLET_BALANCE",
										tmp3.get("walletBalance").toString());
							}
						}

						if (tmp2.get("position") != null) {
							ArrayList<HashMap<String, Object>> al2 = (ArrayList<HashMap<String, Object>>) tmp2
									.get("position");
							for (int j = 0; j < al2.size(); j++) {
								HashMap<String, Object> tmp3 = al2.get(j);
								DataRow DR_OUT_RSET_DATA__POSITION = OUT_RSET_DATA__POSITION.addRow();
								DR_OUT_RSET_DATA__POSITION.setString("SEQ", i + "");
								DR_OUT_RSET_DATA__POSITION.setString("ENTRY_PRICE", tmp3.get("entryPrice").toString());
								DR_OUT_RSET_DATA__POSITION.setString("MARK_PRICE", tmp3.get("markPrice").toString());
								DR_OUT_RSET_DATA__POSITION.setString("POSITION_AMT",
										tmp3.get("positionAmt").toString());
								DR_OUT_RSET_DATA__POSITION.setString("SYMBOL", tmp3.get("symbol").toString());
								DR_OUT_RSET_DATA__POSITION.setString("UN_REALIZED_PROFIT",
										tmp3.get("unRealizedProfit").toString());
							}
						}
					}
				}
