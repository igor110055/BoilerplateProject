...
public class SpotAccountTradePostApiV3NewOrder extends SAProxy {
	public DataSet PostApiV3NewOrder(DataSet InDs, String InDsNames, String outDsNames) throws Exception {
