...
public class WalletEndPointsGetSapiV1AssetDividendRecord extends SAProxy {
	// https://binance-docs.github.io/apidocs/spot/en/#all-coins-39-information-user_data
	public DataSet GetSapiV1AssetDividendRecord(DataSet InDs, String InDsNames, String outDsNames) throws Exception {
		String URL = "https://api.binance.com/sapi/v1/asset/assetDividend";
		...
		OUT_RSET.addColumn("DIV_TIME", dataset.type.DataType.STRING, null, "divTime");
		OUT_RSET.addColumn("EN_INFO", dataset.type.DataType.STRING, null, "enInfo");
		...
		String LIMIT = null; // Default:20, Max:500
		...
		try {
			...
			if (c != null) {
				...
				for (int i = 0; i < al.size(); i++) {
					...
					dr.setString("DIV_TIME", tmp.get("divTime").toString());
					dr.setString("EN_INFO", tmp.get("enInfo").toString());
