...
public class WalletEndPointsGetSapiV1AccountStatus extends SAProxy {
	// https://binance-docs.github.io/apidocs/spot/en/#all-coins-39-information-user_data
	public DataSet GetSapiV1AccountStatus(DataSet InDs, String InDsNames, String outDsNames) throws Exception {
		String URL = "https://api.binance.com/sapi/v1/account/status";
		...
		OUT_RSET.addColumn("DATA", dataset.type.DataType.STRING, null, "data");
		...
		if (c != null) {
			...
			dr.setString("DATA", c.get("data").toString());
		}
