...
public class SpotAccountTradeGetApiV3QueryOco extends SAProxy {
	public DataSet GetApiV3QueryOco(DataSet InDs, String InDsNames, String outDsNames) throws Exception {
		...
		String ORDER_LIST_ID = null;// Either orderListId or origClientOrderId must be provided
		String ORIG_CLIENT_ORDER_ID = null;// Either orderListId or origClientOrderId must be provided
