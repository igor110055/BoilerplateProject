...
public class MarketDataEndPointsGetApiV3OldTradeLookup extends SAProxy {
	// https://binance-docs.github.io/apidocs/spot/en/#all-coins-39-information-user_data
	public DataSet GetApiV3OldTradeLookup(DataSet InDs, String InDsNames, String outDsNames) throws Exception {
		...
		OUT_REST.addColumn("FROM_ID", dataset.type.DataType.STRING, null, "");
		...
		if (!InDs.isExistTable("IN_KEY")) {
			// 에러처리
			drRst.setString("JSON_OUT", "");
			drRst.setString("STATUS", "E");
			drRst.setString("ERR_MSG", "IN_KEY 테이블 인풋으로 넘어오지 않았습니다.");
			drRst.setString("ERR_CODE", "200");
			drRst.setString("ERR_STACK_TRACE", "");
		...
		try {
			jsonOutString = httpU.httpGetBinianceWithApiKey(BINANCE_API_KEY, URL, QueryString);
