...
public class SpotAccountTradeGetApiV3QueryOpenOco extends SAProxy {
	public DataSet GetApiV3QueryOpenOco(DataSet InDs, String InDsNames, String outDsNames) throws Exception {
