...
public class WalletEndPointsGetSapiV1DepositAddress extends SAProxy {
	// https://binance-docs.github.io/apidocs/spot/en/#all-coins-39-information-user_data
	public DataSet GetSapiV1DepositAddress(DataSet InDs, String InDsNames, String outDsNames) throws Exception {
		...
		OUT_RSET.addColumn("TAG", dataset.type.DataType.STRING, null, "tag");
		OUT_RSET.addColumn("URL", dataset.type.DataType.STRING, null, "url");
		...
		if (PjtUtil.g().isEmpty(COIN)) {
			...
			drRst.setString("ERR_MSG", "COIN값이 인풋으로 넘어오지 않았습니다.");
		...
		if (c != null) {
			...
			dr.setString("TAG", c.get("tag").toString());
			dr.setString("URL", c.get("url").toString());
		}
