...
public class WalletEndPointsPostSapiV1DustTransfer extends SAProxy {
	public DataSet PostSapiV1DustTransfer(DataSet InDs, String InDsNames, String outDsNames) throws Exception {
		String URL = "https://api.binance.com/sapi/v1/asset/dust";
		...
		OUT_RSET.addColumn("TOTAL_SERVICE_CHARGE", dataset.type.DataType.STRING, null, "totalServiceCharge");
		OUT_RSET.addColumn("TOTAL_TRANSFERED", dataset.type.DataType.STRING, null, "totalTransfered");

		DataTable OUT_RSET_DATA__TRANSFER_RESULT = OUT_DS.addTable("OUT_RSET_DATA__TRANSFER_RESULT");
		OUT_RSET_DATA__TRANSFER_RESULT.addColumn("AMOUNT");
		OUT_RSET_DATA__TRANSFER_RESULT.addColumn("FROM_ASSET");
		OUT_RSET_DATA__TRANSFER_RESULT.addColumn("OPERATE_TIME");
		OUT_RSET_DATA__TRANSFER_RESULT.addColumn("SERVICE_CHARGE_AMOUNT");
		OUT_RSET_DATA__TRANSFER_RESULT.addColumn("TRAN_ID");
		OUT_RSET_DATA__TRANSFER_RESULT.addColumn("TRANSFERED_AMOUNT");
