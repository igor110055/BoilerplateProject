...
public class MarketDataEndPointsGetApiV3Time extends SAProxy {
	// https://binance-docs.github.io/apidocs/spot/en/#all-coins-39-information-user_data
	public DataSet GetApiV3Time(DataSet InDs, String InDsNames, String outDsNames) throws Exception {
		...
		OUT_REST.addColumn("SERVER_TIME");
		...
		if (c != null) {
			...
			dr.setString("SERVER_TIME", c.get("serverTime").toString());
		}
		return OUT_DS;
	}
