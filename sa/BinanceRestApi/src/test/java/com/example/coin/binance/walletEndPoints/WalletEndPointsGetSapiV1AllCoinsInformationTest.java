...
public class WalletEndPointsGetSapiV1AllCoinsInformationTest {

	@Test
	public void testGetSapiV1AllCoinsInformation() {
		...
		DataSet OUT_DS;
		try {
			OUT_DS = tmp.GetSapiV1AllCoinsInformation(IN_DS, null, null);
