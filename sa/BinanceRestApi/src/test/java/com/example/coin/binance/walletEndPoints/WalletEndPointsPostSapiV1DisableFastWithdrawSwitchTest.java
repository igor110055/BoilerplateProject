...
public class WalletEndPointsPostSapiV1DisableFastWithdrawSwitchTest {

	@Test
	public void testPostSapiV1DisableFastWithdrawSwitch() {
		...
		DataSet OUT_DS;
		try {
			OUT_DS = tmp.PostSapiV1DisableFastWithdrawSwitch(IN_DS, null, null);
