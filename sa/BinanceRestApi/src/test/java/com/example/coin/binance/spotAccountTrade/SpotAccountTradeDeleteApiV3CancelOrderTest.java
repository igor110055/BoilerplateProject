...
public class SpotAccountTradeDeleteApiV3CancelOrderTest {

	@Test
	public void testDeleteApiV3CancelOrder() {
		...
		// DR_IN_PSET.setString("ORIG_CLIENT_ORDER_ID", "ORIG_CLIENT_ORDER_ID");
		// DR_IN_PSET.setString("NEW_CLIENT_ORDER_ID", "NEW_CLIENT_ORDER_ID");
		...
		DataSet OUT_DS;
		try {
			OUT_DS = tmp.DeleteApiV3CancelOrder(IN_DS, null, null);
