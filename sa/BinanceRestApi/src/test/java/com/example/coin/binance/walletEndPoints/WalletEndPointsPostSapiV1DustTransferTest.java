...
public class WalletEndPointsPostSapiV1DustTransferTest {

	@Test
	public void testPostSapiV1DustTransfer() {
		...
		DR_IN_PSET.setString("ASSET", "BTC");
		...
		DataSet OUT_DS;
		try {
			OUT_DS = tmp.PostSapiV1DustTransfer(IN_DS, null, null);
