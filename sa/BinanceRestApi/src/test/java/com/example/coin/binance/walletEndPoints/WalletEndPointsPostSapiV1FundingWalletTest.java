...
public class WalletEndPointsPostSapiV1FundingWalletTest {

	@Test
	public void testPostSapiV1FundingWallet() {
		...
		IN_PSET.addColumn("NEED_BTC_VALUATION"); // true or false
		...
		// DR_IN_PSET.setString("ASSET", "");
		// DR_IN_PSET.setString("NEED_BTC_VALUATION", ""); true or false
		...
		DataSet OUT_DS;
		try {
			OUT_DS = tmp.PostSapiV1FundingWallet(IN_DS, null, null);
