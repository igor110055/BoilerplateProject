...
public class WalletEndPointsGetSapiV1QueryUserUniversalTransferHistoryTest {

	@Test
	public void testGetSapiV1QueryUserUniversalTransferHistory() {
		...
		IN_PSET.addColumn("CURRENT");
		IN_PSET.addColumn("SIZE");
		...
		DR_IN_PSET.setString("TYPE", "MAIN_C2C");
		...
		DataSet OUT_DS;
		try {
			OUT_DS = tmp.GetSapiV1QueryUserUniversalTransferHistory(IN_DS, null, null);
