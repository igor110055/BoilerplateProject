...
public class WalletEndPointsGetSapiV1AccountStatusTest {

	@Test
	public void testGetSapiV1AccountStatus() {
		...
		IN_PSET.addColumn("STATUS"); // 0(0:pending,6: credited but cannot withdraw, 1:success)
		...
		DataSet OUT_DS;
		try {
			OUT_DS = tmp.GetSapiV1AccountStatus(IN_DS, null, null);
