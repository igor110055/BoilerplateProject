...
public class WalletEndPointsGetSapiV1TradeFeeTest {

	@Test
	public void testWalletEndPointsGetSapiV1TradeFee() {
		...
		// DR_IN_PSET.setString("SYMBOL", "ZRXBUSD");
		...
		DataSet OUT_DS;
		try {
			OUT_DS = tmp.GetSapiV1TradeFee(IN_DS, null, null);
