...
public class WalletEndPointsGetSapiV1AssetDividendRecordTest {

	@Test
	public void testGetSapiV1AssetDividendRecord() {
		...
		DataSet OUT_DS;
		try {
			OUT_DS = tmp.GetSapiV1AssetDividendRecord(IN_DS, null, null);
