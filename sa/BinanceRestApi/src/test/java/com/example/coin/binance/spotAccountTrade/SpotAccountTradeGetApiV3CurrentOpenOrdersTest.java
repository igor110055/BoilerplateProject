...
public class SpotAccountTradeGetApiV3CurrentOpenOrdersTest {

	@Test
	public void testGetApiV3CurrentOpenOrders() {
		...
		DataSet OUT_DS;
		try {
			OUT_DS = tmp.GetApiV3CurrentOpenOrders(IN_DS, null, null);
