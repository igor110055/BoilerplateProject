...
public class SpotAccountTradeGetApiV3QueryAllOcoTest {

	@Test
	public void testGetApiV3QueryAllOco() {
		...
		IN_PSET.addColumn("FROM_ID");// If supplied, neither startTime or endTime can be provided
		IN_PSET.addColumn("START_TIME");
		IN_PSET.addColumn("END_TIME");
		IN_PSET.addColumn("LIMIT");// Default Value: 500; Max Value: 1000
		...
		DataSet OUT_DS;
		try {
			OUT_DS = tmp.GetApiV3QueryAllOco(IN_DS, null, null);
