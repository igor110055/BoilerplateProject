...
public class WalletEndPointsGetSapiV1DailyAccountSnapshotSPOTTest {

	@Test
	public void testWalletEndPointsGetSapiV1DailyAccountSnapshotSPOT() {
		...
		DataSet OUT_DS;
		try {
			OUT_DS = tmp.GetSapiV1DailyAccountSnapshotSPOT(IN_DS, null, null);
