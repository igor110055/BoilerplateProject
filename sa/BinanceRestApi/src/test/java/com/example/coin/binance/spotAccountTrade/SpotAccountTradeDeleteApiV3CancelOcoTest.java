...
public class SpotAccountTradeDeleteApiV3CancelOcoTest {

	@Test
	public void testDeleteApiV3CancelOco() {
		...
		IN_PSET.addColumn("ORDER_LIST_ID"); // Either orderListId or listClientOrderId must be provided
		IN_PSET.addColumn("LIST_CLIENT_ORDER_ID"); // Either orderListId or listClientOrderId must be provided
		IN_PSET.addColumn("NEW_CLIENT_ORDER_ID");// Used to uniquely identify this cancel. Automatically generated by
													// default

		IN_PSET.addColumn("RECV_WINDOW");// The value cannot be greater than 60000
		...
		DataSet OUT_DS;
		try {
			OUT_DS = tmp.DeleteApiV3CancelOco(IN_DS, null, null);
