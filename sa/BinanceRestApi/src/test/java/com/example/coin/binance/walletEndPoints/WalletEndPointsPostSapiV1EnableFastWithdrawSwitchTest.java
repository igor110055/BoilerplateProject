...
public class WalletEndPointsPostSapiV1EnableFastWithdrawSwitchTest {

	@Test
	public void testPostSapiV1EnableFastWithdrawSwitch() {
		...
		DataSet OUT_DS;
		try {
			OUT_DS = tmp.PostSapiV1EnableFastWithdrawSwitch(IN_DS, null, null);
