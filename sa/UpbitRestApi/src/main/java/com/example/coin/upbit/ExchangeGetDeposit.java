...
public class ExchangeGetDeposit extends SAProxy {

    public DataSet GetDeposit(DataSet InDs,String InDsNames, String outDsNames) throws Exception {
    	String  URL="https://api.upbit.com/v1/deposit";
