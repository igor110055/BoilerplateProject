...
public class ExchangeGetDepositsCoinAddresses extends SAProxy {

    public DataSet GetDepositsCoinAddresses(DataSet InDs,String InDsNames, String outDsNames) throws Exception {
    	String  URL="https://api.upbit.com/v1/deposits/coin_addresses";
