...
public class ExchangeGetWithdraws extends SAProxy {

    public DataSet GetWithdraws(DataSet InDs,String InDsNames, String outDsNames)  throws Exception {
