...
public class QuotationGetMarketTickerTest {

	@Test
	public void testQuotationGetMarketTicker() {
    	...
    	IN_PSET.addColumn("MARKETS");
    	
    	DataRow DR_IN_PSET = IN_PSET.addRow();
    	DR_IN_PSET.setString("MARKETS", "KRW-BTC");
		...
		DataSet OUT_DS;
		try {
			OUT_DS = tmp.GetMarketTicker( IN_DS, null, null);
