...
public class ExchangeGetWithdrawsChanceTest {

	@Test
	public void testExchangeGetWithdrawsChance() {
    	...
    	DR_IN_PSET.setString("CURRENCY", "USDP");
		...
		DataSet OUT_DS;
		try {
			OUT_DS = tmp.GetWithdrawsChance( IN_DS, null, null);
