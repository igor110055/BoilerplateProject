...
public class ExchangeGetDepositTest {
	...
	public void testExchangeGetDeposit() {
    	...
    	DR_IN_PSET.setString("UUID", "485013b9-0eea-43c4-877a-57e41ae1f163");
    	DR_IN_PSET.setString("TXID", "BKD-2021-03-25-6e2ad277156f4a23ab3b152a7f");
		...
		DataSet OUT_DS;
		try {
			OUT_DS = tmp.GetDeposit( IN_DS, null, null);
