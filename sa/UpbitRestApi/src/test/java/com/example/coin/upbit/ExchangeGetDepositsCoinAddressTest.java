...
public class ExchangeGetDepositsCoinAddressTest {

	@Test
	public void testExchangeGetDepositsCoinAddress() {
    	...
    	DR_IN_PSET.setString("CURRENCY", "VET");
		...
		DataSet OUT_DS;
		try {
			OUT_DS = tmp.GetDepositsCoinAddress( IN_DS, null, null);
