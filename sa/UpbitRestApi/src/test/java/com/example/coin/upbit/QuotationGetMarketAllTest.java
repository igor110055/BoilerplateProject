...
public class QuotationGetMarketAllTest {
	...
	public void testQuotationGetMarketAll() {
		...
		DataSet OUT_DS;
		try {
			OUT_DS = tmp.GetMarketAll( IN_DS, null, null);
