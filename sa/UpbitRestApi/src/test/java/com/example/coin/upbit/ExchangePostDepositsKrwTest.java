...
public class ExchangePostDepositsKrwTest {

	@Test
	public void testExchangePostDepositsKrwTest() {
    	...
    	DR_IN_PSET.setString("AMOUNT", "100");
		...
		DataSet OUT_DS;
		try {
			OUT_DS = tmp.PostDepositsKrw( IN_DS, null, null);
