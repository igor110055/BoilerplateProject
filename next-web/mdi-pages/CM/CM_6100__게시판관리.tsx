...
export  const CM_6100__게시판관리 = () => {   
    ...
    const columns = [
        { key: 'GRP_CD', name: '게시판관리코드', width: 200 ,  sortable: true ,editor: GridTextEditor},
        { key: 'GRP_NM', name: '게시판관리명', width: 200 ,editor: GridTextEditor},
        { key: "RMK", name: '비고', width: 100 ,  sortable: true  ,editor: GridTextEditor},
        { key: 'USE_YN', name: '사용여부', width: 100 ,  sortable: true 
                ,editor: (p:any) =>{
                    return (                    
                        <GridCombo p={p} options={useYnData}  />
                      )
                } ,
                  editorOptions: {
                    editOnClick: true
        ...
        { key: 'ORD', name: '정렬', width: 160  ,editor: GridTextEditor},
