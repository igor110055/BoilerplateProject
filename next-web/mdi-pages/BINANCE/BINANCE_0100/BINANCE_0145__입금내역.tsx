...
export const BINANCE_0145__입금내역= () => {   
    ...
    const columns:OptColumn[] = [ 
        ...
        ,{header: 'NETWORK',name: 'NETWORK',width: 100,align : 'left',sortable : true,resizable: true,sortingType: 'desc'}
        ,{header: 'STATUS',name: 'STATUS',width: 100,align : 'left',sortable : true,resizable: true,sortingType: 'desc'}
        ,{header: 'ADDRESS',name: 'ADDRESS',width: 150,align : 'left',sortable : true,resizable: true,sortingType: 'desc'}
        ,{header: 'ADDRESS_TAG',name: 'ADDRESS_TAG',width: 150,align : 'left',sortable : true,resizable: true,sortingType: 'desc'}
        ,{header: 'TX_ID',name: 'TX_ID',width: 150,align : 'left',sortable : true,resizable: true,sortingType: 'desc'}
        ,{header: 'INSERT_TIME',name: 'INSERT_TIME',width: 150,align : 'left',sortable : true,resizable: true,sortingType: 'desc'}
        ,{header: 'TRANSFER_TYPE',name: 'TRANSFER_TYPE',width: 150,align : 'left',sortable : true,resizable: true,sortingType: 'desc'}
        ,{header: 'CONFIRM_TIMES',name: 'CONFIRM_TIMES',width: 150,align : 'left',sortable : true,resizable: true,sortingType: 'desc'}
    ];
