...
export const BINANCE_0355__OCO주문내역USER_DATA= () => {   
    ...
    const fnSearchHandler= async (data: IFormInput) => {
        ...
        send("BR_SPOT_ACCOUNT_TRADE_GET_API_V3_QueryOco", {
            brRq : 'IN_PSET'
    ...
    return (
            ...
            <Stack
                ...
                spacing={0.5}
                >
                    <FormTextFiled name="ORDER_LIST_ID" control={control} label="ORDER_LIST_ID" sx={{width:200}}  rules={{ required: false }}   />
                    <FormTextFiled name="ORIG_CLIENT_ORDER_ID" control={control} label="ORIG_CLIENT_ORDER_ID" sx={{width:200}}  rules={{ required: false }}   />
                    
                    <Button variant="contained" color="success"   onClick={handleSubmit(fnSearchHandler)}>OCO 조회</Button>
            </Stack>
            <TuiGrid   columns={
                        [
