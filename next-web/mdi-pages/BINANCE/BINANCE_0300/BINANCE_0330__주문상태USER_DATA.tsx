...
export const BINANCE_0330__주문상태USER_DATA= () => {   
    ...
    const fnSearchHandler= async (data: IFormInput) => {
        ...
        send("BR_SPOT_ACCOUNT_TRADE_GET_API_V3_QueryOrder", {
            brRq : 'IN_PSET'
            ,brRs : 'OUT_RSET'
            ,IN_PSET : [ data ]
    ...
    return (
            ...
            <Stack
                ...
                >
                    ...
                    <Button variant="contained" color="success"   onClick={handleSubmit(fnSearchHandler)}>주문상태</Button>
            </Stack>
            <TuiGrid   columns={
                        [
