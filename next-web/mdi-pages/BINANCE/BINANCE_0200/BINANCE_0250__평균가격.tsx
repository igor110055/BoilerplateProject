...
export const BINANCE_0250__평균가격= () => {   
    ...
    const fnSearch= async (data: IFormInput) => {
        ...
        if(childRef.current){
            childRef.current.loadData({
                                        BR:"BR_BINANCE_MARKET_GET_API_V3_AvgPrice",
                                        PARAM: {
                                            brRq : 'IN_DATA'
                                            ,brRs : 'OUT_RSET'
                                            ,IN_DATA: [data]
    ...
    return (
            ...
            <TuiGrid   columns={
                        [
                            ...
                            ,{header: 'MINS',name: 'MINS',width: 100,align : 'left',sortable : true,resizable: true,sortingType: 'desc',filter : {type : 'text',showApplyBtn : true,showClearBtn : true} /*text, number, select, date 4가지가 있다.*/}
                        ]
                        }   ref={childRef} />
            </>
    )
