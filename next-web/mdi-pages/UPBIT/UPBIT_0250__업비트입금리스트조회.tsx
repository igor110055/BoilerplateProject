...
export const UPBIT_0250__업비트입금리스트조회= () => {   
    ...
    const fnSearch= async (data: IFormInput) => {
        ...
        if(childRef.current){
            childRef.current.loadData({
                                        BR:"BR_UPBIT_EXCHANGE_GET_DEPOSITS",
                                        PARAM: {
      ...
      const columns:OptColumn[] = [ 
        ...
        ,{header: '입금에 대한 고유 아이디',name: 'UUID',width: 140,align : 'center',filter : {type : 'text',showApplyBtn : true,showClearBtn : true}}
        ...
        ,{header: '입금의 트랜잭션 아이디',name: 'TXID',width: 140,align : 'right',sortable : true,resizable: true,sortingType: 'desc'}
        ,{header: '입금 상태',name: 'STATE',width: 100,align : 'center',sortable : true,resizable: true,sortingType: 'desc'}
        ,{header: '입금 생성 시간',name: 'CREATED_AT',width: 200,sortable: true,align: "center"}
        ,{header: '입금 완료 시간',name: 'DONE_AT',width: 200,sortable: true,align: "center"}
        ,{header: '입금 수량',name: 'AMOUNT',width: 140,align : 'right',sortable: true}
        ,{header: '입금 수수료',name: 'FEE',width: 140,align : 'right',sortable: true}
        ,{header: '입금 유형',name: 'TRANSACTION_TYPE',width: 140,sortable: true,align: "center"}
    ];
    return (
            <>
            <Stack
