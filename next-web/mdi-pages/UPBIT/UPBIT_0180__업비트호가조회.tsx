...
export const UPBIT_0180__업비트호가조회= () => {   
    ...
    const syncHandler= async (data: IFormInput) => {
      ...
      const columns:OptColumn[] = [ 
        ...
        ,{header: '호가 매도 총 잔량',name: 'TOTAL_ASK_SIZE',width: 200,align : 'right',renderer : {type: commaRenderer},sortable : true,resizable: true,sortingType: 'desc'}
        ,{header: '호가 매수 총 잔량',name: 'TOTAL_BID_SIZE',width: 200,align : 'right',renderer : {type: commaRenderer},sortable : true,resizable: true,sortingType: 'desc'}
        ,{header: '호가 생성 시각',name: 'TIMESTAMP',width: 200,align : 'center',sortable : true,resizable: true,sortingType: 'desc'}
