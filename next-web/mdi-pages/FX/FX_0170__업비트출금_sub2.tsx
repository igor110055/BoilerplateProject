...
export const FX_0170__업비트출금_sub2= () => {   
    ...
    const fnSearch= async (data: IFormInput) => {
        if(childRef.current){
            childRef.current.loadData({
                                        BR:"BR_UPBIT_WITHDRAW_retrieveUpbitWithdrawsOutLog",
                                        PARAM: {
                                            brRq : 'IN_PSET'
                                            ,brRs : 'OUT_RSET'
                                            ,IN_PSET:[data]
      ...
      const columns:OptColumn[] = [ 
        ...
        ,{header : 'TYPE',name : 'TYPE',width : 100,resizable : false}
        ,{header : 'UUID',name : 'UUID',width : 100,align : "left"}
        ,{header : 'CURRENCY',name : 'CURRENCY',width : 30,resizable : false,align : "center"}
        ,{header : 'TXID',name : 'TXID',width : 70,align : "center"}
        ,{header : 'STATE',name : 'STATE',width : 40,align : "center"}
        ,{header : 'CREATED_AT',name : 'CREATED_AT',width : 80,resizable : false,align : "right"}
        ,{header : 'DONE_AT',name : 'DONE_AT',width : 80,resizable : false,align : "right"}
        ,{header : 'AMOUNT',name : 'AMOUNT',width : 80,align : "right"}
        ,{header : 'FEE',name : 'FEE',width : 130,align : "right"}
        ,{header : 'TRANSACTION_TYPE',name : 'TRANSACTION_TYPE',width : 100,align : "right"}
