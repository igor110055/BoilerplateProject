...
export const FX_0121__KRW업비트TO바이낸스호가REPORT= () => {   
    ...
    const header:OptHeader =   {
        height: 60,
        complexColumns: [
            {header: '매수시점-단가',name: 'mergeColumn1',childNames: ['FST_UPBIT_MARKET','FST_BINANCE_SYMBOL','FST_UPBIT_PRICE','FST_BINANCE_PRICE_KRW','FST_BINANCE_PRICE_USD','FST_GAP','FST_PER']} 
            ...
            ,{header: '매도시점-단가',name: 'mergeColumn3',childNames: ['LST_UPBIT_MARKET','LST_BINANCE_SYMBOL','LST_BINANCE_PRICE_KRW','LST_BINANCE_PRICE_USD','LST_UPBIT_PRICE','LST_GAP','LST_PER']} 
      ...
      const columns:OptColumn[] = [
        ...
        ,{header: 'PER',name: 'LST_SUM_PER',width: 40,align : 'right',sortable : false,resizable: true,sortingType: 'desc',renderer : {type: commaStRenderer,options : {tgt : 'LST_UPBIT_SUM_AMT'}}}
