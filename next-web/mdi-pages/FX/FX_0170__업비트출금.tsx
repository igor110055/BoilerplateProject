...
import { FX_0170__업비트출금_sub1 } from './FX_0170__업비트출금_sub1';
import { FX_0170__업비트출금_sub2 } from './FX_0170__업비트출금_sub2';




export const FX_0170__업비트출금= () => {   
    ...
    return (
            ...
            <table>
            <tr>
                <td><FX_0170__업비트출금_sub1  /></td>
                <td width="30"></td>
                <td><FX_0170__업비트출금_sub2  /></td>
            </tr>
            </table>            
            </>
    )
