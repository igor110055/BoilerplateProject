...
export const FX_0135__업비트호가= () => {   
    ...
    const fnSearch= async (data: IFormInput) => {
      ...
      const columns:OptColumn[] = [ 
        ...
        ,{header: 'MARKET',name: 'MARKET',width: 100,align : 'left',sortable : false,resizable: true,sortingType: 'desc'}
        ,{header: 'SEQ',name: 'SEQ',width: 30,align : 'right',sortable : false,resizable: true,sortingType: 'desc'}
        ,{header: 'ASK_PRICE',name: 'ASK_PRICE',width: 100,align : 'right',sortable : false,resizable: true,sortingType: 'desc'}
        ,{header: 'BID_PRICE',name: 'BID_PRICE',width: 100,align : 'right',sortable : false,resizable: true,sortingType: 'desc'}
        ,{header: 'ASK_SIZE',name: 'ASK_SIZE',width: 240,align : 'right',sortable : false,resizable: true,sortingType: 'desc'}
        ,{header: 'BID_SIZE',name: 'BID_SIZE',width: 240,align : 'right',sortable : false,resizable: true,sortingType: 'desc',renderer : {type: commaRenderer}}
        ,{header: 'TRADE_TYPE',name: 'TRADE_TYPE',width: 100,align : 'right',sortable : false,resizable: true,sortingType: 'desc',renderer : {type: commaRenderer}}
