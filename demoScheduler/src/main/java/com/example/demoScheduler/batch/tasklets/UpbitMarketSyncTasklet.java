...
public class UpbitMarketSyncTasklet implements Tasklet {
    @Autowired
    ...
    public RepeatStatus execute(StepContribution contribution, ChunkContext chunkContext) throws Exception {
        log.info("UpbitMarketSyncTasklet  executed tasklet !!");
		...
		String jsonOutString = goS.callApiBizActorMap("BR_UPBIT_MARKET_SYNC", inDS);
