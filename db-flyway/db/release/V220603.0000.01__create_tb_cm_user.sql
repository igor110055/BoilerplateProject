...
(
    ...
    CONSTRAINT tb_cm_user_pkey PRIMARY KEY (user_uid)
);
comment on table tb_cm_user is '사용자테이블';

comment on column tb_cm_user.user_uid is '사용자uid';
...
comment on column tb_cm_user.crt_user_uid is '생성자uid';
comment on column tb_cm_user.updt_user_uid is '수정자uid';
