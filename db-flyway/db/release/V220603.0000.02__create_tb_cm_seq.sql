...
(
    ...
    crt_usr_uid  character varying(32) ,
    updt_usr_uid  character varying(32) ,
...
comment on column tb_cm_seq.crt_usr_uid is '생성자uid';
comment on column tb_cm_seq.updt_usr_uid is '수정자uid';
